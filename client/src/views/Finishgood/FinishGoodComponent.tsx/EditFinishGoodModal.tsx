...
// import { updateFinishGood, GetFinishGood } from 'src/features/FinishGood/FinishGoodSlice';
// // import { Icon } from '@iconify/react';

// const EditFinishGoodModal = ({ show, setShowmodal, autoclave }) => {
...
//   useEffect(() => {
//     const segData = autoclave?.FinishGood_entries?.[0];
//     if (segData) {
//       setFormData({
//         id: segData?.id || '',
...
//       toast.success(result.message || 'FinishGood entry updated successfully');
//       dispatch(GetFinishGood());
//       setShowmodal(false);
//     } catch (err) {
//       toast.error('Failed to update FinishGood entry');
//     }
//   };

//   return (
//     <Modal show={show} onClose={() => setShowmodal(false)} size="4xl">
//       <ModalHeader>Edit FinishGood Entry</ModalHeader>
